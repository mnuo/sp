<template>
  <div>
    ...
    <el-table border :data="tableData">
      ...
      <el-table-column prop="method" header-align="center" align="center" label="运输方式"
                       min-width="50"></el-table-column>
      <el-table-column prop="price" header-align="center" align="center" label="现执行运价（元/吨)"
                       min-width="50"></el-table-column>
      <el-table-column prop="addPrice" header-align="center" align="center" label="补贴金额（元/吨)"
                       min-width="50"></el-table-column>
    ...
    <div>
      <el-dialog :visible.sync="dialogAddOne" title="新增" v-dialogDrag width="35%" center>
        ...
        <el-row class="row-top">
          ...
          <el-col :span="12" class="text-left">
            <el-input id="input" v-model="saveOneData.price" type="number"></el-input>
          </el-col>
        ...
        <el-row class="row-top">
          ...
          <el-col :span="12" class="text-left">
            <el-input v-model="saveOneData.addPrice" type="number"></el-input>
          </el-col>
          <el-col :span="5" class="text-right">
            （元/吨)
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-select v-model="saveOneData.method" class="my-row">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      findAll() {
        Policy_API.findAllPoTransport().then(res => {
      ...
      doSave() {
        ...
        if (this.saveOneData.price === null) {
          this.$message.error('现执行运价未填写');
          return;
        }
        if (this.saveOneData.addPrice === null) {
          this.$message.error('补贴金额未填写');
          return;
        }
        if (this.saveOneData.method === null) {
          this.$message.error('运输方式未选择');
          return;
        }

        this.dialogAddOne = false;
        Policy_API.savePoTransport(this.saveOneData).then(res => {
          this.$message({
