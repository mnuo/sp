<template>
  <div>
    ...
    <el-table-column prop="deposit" header-align="center" label="定金标准(元/吨)" min-width="150"></el-table-column>
    <el-table-column prop="startTime" header-align="center" label="开始执行时间" min-width="150"></el-table-column>
    <el-table-column prop="endTime" header-align="center" label="结束时间" min-width="150"></el-table-column>
    </el-table>
  </div>
</template>
<script>
...
export default {
  ...
  methods:{
    ...
    findHistoryDeposit(){
      this.loading=true;
      Deposit_API.findHistoryDeposit().then(res=>{
