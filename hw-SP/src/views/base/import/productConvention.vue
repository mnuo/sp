<template>
  <div>
    ...
    <el-table-column prop="platform" header-align="center" label="生产机台" min-width="100"></el-table-column> 
    <el-table-column prop="className" :formatter="formatClassName" header-align="center" label="产品类型" min-width="55">
    </el-table-column>
    <!-- <el-table-column prop="kindText" header-align="center" label="规格型号" min-width="90"></el-table-column> -->
    <el-table-column prop="guige" header-align="center" align="center"  label="规格型号(定量、幅宽、层数)" min-width="85">
      <template slot-scope="scope">
          {{scope.row.ration+'克/'+scope.row.width+'mm/'+ scope.row.layer+'层'}}
      </template>
    </el-table-column>
